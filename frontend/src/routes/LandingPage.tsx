...
export function LandingPage() {
  ...
  return (
    <div className="scroll-smooth bg-slate-50 text-slate-900 antialiased">
      ...
      <footer
        id="contact"
        className="brand-footer border-t border-violet-500/20 text-slate-400"
      >
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[1.35fr_0.8fr_0.8fr_1fr] lg:gap-16">
            <div>
              ...
              <p className="mt-5 max-w-sm text-sm leading-relaxed text-violet-100/70">
                At Thesdel, we believe that learning should be as unique as you
                are. Our AI-powered platform creates personalized lessons
                designed to meet your goals, pace, and interests.
              </p>
            </div>
            <div>
